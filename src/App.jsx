...
const SYSTEMS = {
    test: { label: "Test", prefix: "test", facilities: ["Northside", "NEGA"], color: "#f80" }, // Orange from screenshot
...
const SEED = [
    { id: 1, vendor: "MiMedx", facility: "Northside", date: "2026-02-06", productName: "EpiFix", itemNumber: "GS44-Something", cost: 1500, patient: "Doe, John" },
    { id: 2, vendor: "MiMedx", facility: "Northside", date: "2026-02-06", productName: "EpiFix", itemNumber: "GS44-Other", cost: 1500, patient: "Doe, Jane" },
    { id: 3, vendor: "MiMedx", facility: "NEGA", date: "2026-02-11", productName: "AmnioEffect", itemNumber: "LS46-Test", cost: 3200, patient: "Smith, Bob" },
    { id: 4, vendor: "MiMedx", facility: "NEGA", date: "2026-02-11", productName: "AxioFill", itemNumber: "PM05-Demo", cost: 2845, patient: "Ray, Ray" }
];
...
export default function App() {
    ...
    const S = {
        ...
        gridBtn: {
            ...
            gap: 6, background: "transparent", border: "none", color: "#667", fontSize: 13,
            padding: 12, borderRadius: 12, cursor: "pointer", transition: "0.2s"
        },
        gridBtnActive: { background: "#1a1a2e", color: "#fff" },
        iconBox: { width: 20, height: 20, marginBottom: 2 },
        ...
        <div style={{ background: S.bg, minHeight: "100vh", color: S.textMain, fontFamily: "Inter, sans-serif", paddingBottom: 40 }}>
            ...
            <div style={{ padding: "16px 20px 0" }}>
                ...
                <div style={{ display: "flex", gap: 8, marginBottom: 20 }}>
                    <select value={sys} onChange={e => setSys(e.target.value)} style={{ ...S.pill, background: "#121217", appearance: "none", paddingRight: 32, cursor: "pointer", color: S.accent, fontWeight: 600 }}>
                        ...
                        <option value="kancherla">Kancherla</option>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", padding: "0 12px", marginBottom: 24 }}>
                {[
                    ...
                    ["Emails", Icons.Email, "emails"],
                ].map(([l, i, k]) => (
                    <button key={k} onClick={() => setTab(k)} style={{ ...S.gridBtn, ...(tab === k ? S.gridBtnActive : {}) }}>
                            ...
                            <div key={e.id} style={{ display: "grid", gridTemplateColumns: "45px 70px 90px 1fr 60px", padding: "14px 12px", borderBottom: "1px solid #121219", alignItems: "center", fontSize: 12 }}>
                                <div>
                                    <span style={{
                                        ...
                                        background: e.facility === "Northside" ? "rgba(255,0,170,0.15)" : "rgba(0,170,255,0.15)",
                                        color: e.facility === "Northside" ? "#f0a" : "#0af",
